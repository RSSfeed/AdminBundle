<?php
namespace ITF\AdminBundle\Controller\Upload;
...
/**
 *
 * @Route("/upload/fineuploader/{bundle}/{entity}/{property}/{id}/{fk_bundle}/{fk_entity}", defaults={
...
class FineuploaderController extends Controller
{
    ...
    /**
     * @Route("/filelist", name="admin_upload_fineuploader_list")
     *
    ...
    /**
     * @Route("/upload", name="admin_upload_fineuploader_upload")
     *
     * @param Request $request
     * @param $bundle
     * @param $entity
    ...
    /**
     * @Route("/delete", name="admin_upload_fineuploader_delete")
     *
     * @param Request $request
     * @param $bundle
     * @param $entity
